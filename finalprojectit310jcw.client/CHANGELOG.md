...
- Create Angular project with ng: `ng new finalprojectit310jcw.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`finalprojectit310jcw.client.esproj`).
